...
namespace Aoxiang\ESign\SignFlow;
...
class SignFlow extends AbstractAPI
{
    ...
    public function addDocuments($flowId, $fileId, $encryption = 0, $fileName = null, $filePassword = null)
    {
        ...
        $params = [
            'docs' => [
                [
                    'fileId'       => $fileId, 'encryption' => $encryption, 'fileName' => $fileName,
     ...
     * @throws HttpException
     */
    public function downloadDocuments($flowId)
    {
        $url = "/v1/signflows/{$flowId}/documents";
     ...
     * @throws HttpException
     */
    public function addPlatformSign(
        $flowId,
        $fileId,
        $sealId,
        $posPage,
     ...
     * @throws HttpException
     */
    public function endSignFlow($flowId)
    {
        $url = "/v1/signflows/{$flowId}/archive";
